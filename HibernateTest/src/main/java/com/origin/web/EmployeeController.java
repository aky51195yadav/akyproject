...
public class EmployeeController {
	...
	public String getDetails(@RequestParam String userName, @RequestParam String password, Model model) {
		...
		System.out.println(emp + "      555555555555555555555555555555555555555555555");

		boolean b = empService.userValidation(userName);
		boolean b1 = empService.pwdValidation(password);
		if (!b) {
